...
void main() {
  group('Model Mapper and ModelUtils', () {
    const _ErrorMapper mapper = _ErrorMapper();
    test('Given const model contracts and markers When extending them Then the original extension points remain available', () {
    ...
    test('Given maps encoded objects null or invalid input When converting Then legacy map coercions apply', () {
    ...
    test('Given mixed lists or non-lists When decoding Then only maps survive in original order', () {
    ...
    test('Given a failing decoder When processing retained records Then the original error stops decoding', () {
