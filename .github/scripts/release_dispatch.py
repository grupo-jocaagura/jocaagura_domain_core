...
def require_cp0(evidence):
    try:
        claims = evidence['observed_claims']
        audit = evidence['audit_log_attribution']
        ...
        valid = (
            ...
            and audit['url'] == f'https://pub.dev/packages/{PACKAGE}/activity-log'
        )
    except (KeyError, TypeError):
        valid = False
    if not valid:
        raise ValueError('Completed package-specific CP-0 evidence is required')
