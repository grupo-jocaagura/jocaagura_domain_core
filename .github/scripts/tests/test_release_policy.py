...
class ReleasePolicyTests(unittest.TestCase):
    def test_canonical_publishable_sdk_only_identity(self):
        ...
        cases = [SPEC.replace("name: jocaagura_domain_core", "name: wrong_package"),
    ...
    def test_actual_repository_keeps_the_published_name_and_entrypoint(self):
        ...
        self.assertTrue((ROOT / "lib/jocaagura_domain_core.dart").is_file())
    ...
    def test_official_pr_and_exact_merge_commit(self):
        ...
        for side, key, value in [("base", "ref", "develop"), ("head", "ref", "feature"),
                                 ("head", "repo", {"full_name": "fork/jocaagura_domain_core"}),
                                 ("base", "repo", {"full_name": "fork/jocaagura_domain_core"})]:
            wrong = deepcopy(PR)
    ...
    def test_invalid_service_responses_fail_closed(self):
        ...
        url = "https://pub.dev/api/packages/jocaagura_domain_core"
